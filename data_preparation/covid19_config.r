...
## Present file includes some workstation specific data. It is used to identify where on the workstation various folders are found.
## This file should be placed in the user's home folder (~). Example: /home/jan/covid19_config.r
